...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("wall/form.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for (String postid : postids) {
            ...
            for (String commentid : commentids) {
                String BossID = request.getParameter("BossID" + commentid);
                if (BossID.equals(postid)) {
                    Comment c = new Comment();
                    c.setId(Integer.parseInt(commentid));
                    c.setComment(request.getParameter("commentcontent" + commentid));
                    c.setPost(p);
                    p.getComments().add(c);
                }
            }
        ...
        request.getRequestDispatcher("wall/view.jsp").forward(request, response);
